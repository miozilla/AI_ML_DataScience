...
| - | ![conva_fb ✈️📝🗼](https://github.com/miozilla/conva_fb) | Flight Booker | Conversational Agent Flow, Dialog Flow | 
...
| - | ![nanobanana 🐵🍌🖼️](https://github.com/miozilla/nanobanana) | Gemini Flash Image Model | Generate & Edit Images with Nano Banana, Gen AI SDK, Vertex AI Studio UI | 
...
| - | ![tfcv 🔶🔗👓](https://github.com/miozilla/tfcv) | Computer Vision TensorFlow | Design, Compile, Train, Evaluate Model Performance, Save, Load, Callbacks, Network Layers | 
